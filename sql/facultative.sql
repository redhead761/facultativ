...
--    INSERT INTO user VALUES(DEFAULT, 'Selyse ', '191919', 'Selyse', 'Baratheon', 'Selyse@game.com', DEFAULT, (SELECT id FROM role WHERE name='STUDENT'));
    ...
    -- courses
    -- --coming soon
    INSERT INTO course VALUES(DEFAULT, 'Java', 20, '2020-11-22', DEFAULT, DEFAULT, (SELECT id FROM category WHERE title="PROGRAMMING"), (SELECT id FROM status WHERE title="COMING_SOON"));
    INSERT INTO course VALUES(DEFAULT, 'English', 100, '2020-11-22', DEFAULT, DEFAULT, (SELECT id FROM category WHERE title="FOREIGN_LANGUAGE"), (SELECT id FROM status WHERE title="COMING_SOON"));
    INSERT INTO course VALUES(DEFAULT, 'Higher mathematics', 100, '2020-11-22', DEFAULT, DEFAULT, (SELECT id FROM category WHERE title="MATH"), (SELECT id FROM status WHERE title="COMING_SOON"));

    -- --in progress
     INSERT INTO course VALUES(DEFAULT, 'Python', 100, '2020-11-08', DEFAULT, DEFAULT, (SELECT id FROM category WHERE title="PROGRAMMING"), (SELECT id FROM status WHERE title="IN_PROCESS"));
     INSERT INTO course VALUES(DEFAULT, 'Polish', 100, '2020-11-08', DEFAULT, DEFAULT, (SELECT id FROM category WHERE title="FOREIGN_LANGUAGE"), (SELECT id FROM status WHERE title="IN_PROCESS"));
     INSERT INTO course VALUES(DEFAULT, 'Basics of geometry', 100, '2020-11-08', DEFAULT, DEFAULT, (SELECT id FROM category WHERE title="MATH"), (SELECT id FROM status WHERE title="IN_PROCESS"));

     -- --completed
     INSERT INTO course VALUES(DEFAULT, 'C++', 50, '2020-05-08', DEFAULT, DEFAULT, (SELECT id FROM category WHERE title="PROGRAMMING"), (SELECT id FROM status WHERE title="COMPLETED"));
     INSERT INTO course VALUES(DEFAULT, 'Italian ', 100, '2020-05-08', DEFAULT, DEFAULT, (SELECT id FROM category WHERE title="FOREIGN_LANGUAGE"), (SELECT id FROM status WHERE title="COMPLETED"));
     INSERT INTO course VALUES(DEFAULT, 'Mathematical analysis', 100, '2020-05-08', DEFAULT, DEFAULT, (SELECT id FROM category WHERE title="MATH"), (SELECT id FROM status WHERE title="COMPLETED"));

    -- --users_course
     insert into users_course VALUES (1,1,DEFAULT);
     UPDATE course SET amount_students = amount_students + 1 WHERE id=1;
     insert into users_course VALUES (1,2,DEFAULT);
      UPDATE course SET amount_students = amount_students + 1 WHERE id=1;
     insert into users_course VALUES (1,3,DEFAULT);
      UPDATE course SET amount_students = amount_students + 1 WHERE id=1;
     insert into users_course VALUES (2,1,DEFAULT);
      UPDATE course SET amount_students = amount_students + 1 WHERE id=2;
     insert into users_course VALUES (2,2,DEFAULT);
      UPDATE course SET amount_students = amount_students + 1 WHERE id=2;
     insert into users_course VALUES (2,3,DEFAULT);
      UPDATE course SET amount_students = amount_students + 1 WHERE id=2;
     insert into users_course VALUES (3,1,DEFAULT);
      UPDATE course SET amount_students = amount_students + 1 WHERE id=3;
     insert into users_course VALUES (3,2,DEFAULT);
      UPDATE course SET amount_students = amount_students + 1 WHERE id=3;
     insert into users_course VALUES (3,3,DEFAULT);
      UPDATE course SET amount_students = amount_students + 1 WHERE id=3;
