    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (req.getParameter("action") == null) {
            ...
            switch (action) {
                ...
                case "choosecategory" -> courses = new CourseService().coursesByCategory(req.getParameter("category"));
                case "enroll" ->
                        new CourseService().addUserToCourse(req.getParameter("courseId"), req.getParameter("userId"));
                case "myCourse" -> {courses = new CourseService().findCoursesForStudent(req.getParameter("userId"));
