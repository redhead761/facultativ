                                        ...
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <div class="form-floating">
                                                <input type="number" id="duration" class="form-control form-control-lg"
                                                       ...
                                                       min="1" max="999"
                                                       title="<fmt:message key="duration.validate.message"/>" required/>
                                                <label class="form-label" for="duration"><fmt:message
                                                        key="duration"/></label>
                                            </div>
                                            ...
                                            <c:forEach var="status" items="${sessionScope.statuses}">
                                                <div class="form-check form-check-inline">
                                                    ...
                                                    <label class="form-check-label"
                                                           for="status"><fmt:message
                                                            key="${status.valueOf(status)}"/></label>
                                                </div>
                                            </c:forEach>
                                        </div>
                                    </div>
