        ...
        <ul class="pagination justify-content-center">
            ...
            <c:if test="${requestScope.currentPage > 1}">
                <li class="page-item"><a class="page-link"
                                         href="${pageContext.request.contextPath}/controller?action=manage_categories&page=${requestScope.currentPage-1}">Previous</a>
                </li>
            </c:if>
            ...
            <c:if test="${requestScope.noOfCategoriesPages - requestScope.currentPage >= 1}">
                <li class="page-item"><a class="page-link"
                                         href="${pageContext.request.contextPath}/controller?action=manage_categories&page=${requestScope.currentPage+1}">${requestScope.currentPage+1}</a>
                </li>
            </c:if>
            ...
            <c:if test="${requestScope.noOfCategoriesPages - requestScope.currentPage >= 2}">
                <li class="page-item"><a class="page-link"
                                         href="${pageContext.request.contextPath}/controller?action=manage_categories&page=${requestScope.currentPage+2}">${requestScope.currentPage+2}</a>
                </li>
            </c:if>
            ...
            <c:if test="${requestScope.noOfCategoriesPages - requestScope.currentPage >= 1}">
                <li class="page-item"><a class="page-link"
                                         href="${pageContext.request.contextPath}/controller?action=manage_categories&page=${requestScope.currentPage+1}">Next</a>
                </li>
            </c:if>
        </ul>
    </nav>
