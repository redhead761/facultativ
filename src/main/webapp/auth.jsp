...
<div align="center">
    ...
    <c:if test="${error != null}">
        <div class="alert alert-warning d-flex align-items-center col-lg-2" role="alert">
            <svg class="bi flex-shrink-0 me-2" width="24" height="12" role="img" aria-label="Warning:">
