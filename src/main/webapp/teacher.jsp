...
<html>
    ...
    <body>
        <h2> Teacher data </h2><hr>
        Name: ${user.name}<br>
        Surname: ${user.surname}<br>
        Email: ${user.email}<br>
        <a href="controller?action=show_teacher_courses&user_id=${user.id}">My courses</a><br><br>
        <a href="controller?action=log_out">Log out</a>

        <form action="controller">
            <input type="hidden" name="action" value="sort" />
            <input type="hidden" name="cabinet_type" value="teacher" />
