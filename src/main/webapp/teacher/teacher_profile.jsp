                    ...
                    <div class="card-body text-center">
                        ...
                        <form class="mx-1 mx-md-4" action="${pageContext.request.contextPath}/controller"
                            ...
                            <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                                <button type="submit" class="btn btn-primary btn-sm"><fmt:message key="submit"/></button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-lg-8">
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <p class="mb-0"><fmt:message key="degree"/></p>
                            </div>
                            <div class="col-sm-9">
                                <p class="text-muted mb-0">${sessionScope.user.degree}</p>
                            </div>
                        </div>
                    </div>
                </div>
