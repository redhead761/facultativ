...
import static com.epam.facultative.controller.constants.PageNameConstants.STUDENT_PAGE;
...
class ShowAllCoursesActionTest {
    ...
    void executePostSuccessful() throws ServiceException {
        try (MockedStatic<ActionUtils> actionUtils = mockStatic(ActionUtils.class)) {
            ...
            String path = new ShowAllCoursesAction(appContext).execute(req, resp);
            assertEquals(STUDENT_PAGE, path);
        }
    }
}